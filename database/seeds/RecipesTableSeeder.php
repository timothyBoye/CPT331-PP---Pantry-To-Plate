...
class RecipesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Recipe::create(array('id' => 1,'name' => 'Spaghetti Bolognese',
            ...
            'method' => 'Put a large saucepan on a medium heat and add 1 tbsp olive oil. Add the bacon and fry for 10 mins until golden and crisp.;Reduce the heat and add the onion, carrot, celery, garlic and rosemary, then fry for 10 mins. Stir the veg often until it softens.;
        ...
        Recipe::create(array('id' => 3,'name' => 'Easy Pizza Sauce',
            ...
            'method' => 'Heat the olive oil over medium heat, and saute the garlic for 2 minutes.;
        ...
        Recipe::create(array('id' => 4,'name' => 'Fresh Cherry Syrup',
            ...
            'method' => 'In a medium saucepan, combine all ingredients. You can pit the cherries or leave them with the pits if you\'d like. Either way is fine.;
        ...
        Recipe::create(array('id' => 5,'name' => 'Maple Sriracha Grilled Pork Chops',
            ...
            'method' => 'Combine garlic, sriracha, maple syrup, and lime. Thoroughly coat the pork chops and marinate 1-8 hours.;
        ...
        Recipe::create(array('id' => 7,'name' => 'Sourdough Bread with Avocado Spread',
            ...
            'method' => 'Toast the bread in a toaster or in the oven.;
            Wash the avocados, cut them in half and remove the peck. Using fork take out the flesh and place in a bowl. Mash the flesh with fork to get a paste. Add chia seeds, olive oil, a generous splash of lemon juice (freshly squeezed) and mix all together.;
            Place the toasted bread onto a plate & spread the avocado mix over. Top with arugula leaves and a few slices of goat cheese.;
            Add some black pepper and an extra splash of olive oil, if desired.;
            Serve for breakfast or as a snack any time of the day!;
            Enjoy!',
            'serving_size' => 4,
        ...
        Recipe::create(array('id' => 9,'name' => 'Kidney Bean Salad',
            ...
            'method' => 'Start off with draining and rinsing the kidney beans, then toss them in a bowl or tupperware.;
            Mix in your diced bell peppers, onion, and parsley.;
            Drizzle the olive oil and mix well.;
            Add desired amount of lemon. I love lemon so I will use two or more lemons.;
            Salt to taste.',
            'serving_size' => 6,
            'cuisine_type_id' => CuisineType::where('name', 'like', '%Western%')->value('id'),
        ...
        Recipe::create(array('id' => 10,'name' => 'Roasted Parmesan Broccoli',
            ...
            'method' => 'Preheat the oven to 425 degrees.;
        ...
        Recipe::create(array('id' => 11,'name' => 'Smoky Paprika Chicken',
            ...
            'method' => 'Cut the chicken into small bite-sized pieces and place them in the mixing bowl. Add olive oil, paprika, salt and pepper and stir everything together.;
        ...
        Recipe::create(array('id' => 12,'name' => 'Cumin Orange Cashew Salad',
            ...
            'method' => 'Cut or tear the mixed greens into small pieces. Put them in a bowl and set aside.;
            ...
            Take the cashew nuts off the heat and mix them with the oranges and greens. Serve immediately.;
        ...
        Recipe::create(array('id' => 13,'name' => 'Halloumi, Blueberry & Spinach Salad',
            ...
            'method' => 'Cut the Halloumi cheese into slices or even cubes.;
        ...
        Recipe::create(array('id' => 15,'name' => 'Chocolate Blackberry Pudding',
            ...
            'method' => 'Preheat the oven to 190C/385F degrees.;
        ...
        Recipe::create(array('id' => 17,'name' => 'Arugula Pesto Pasta Salad',
            ...
            'method' => 'Cook the pasta in salted boiling water until al dente. Drain and rinse with cold water. Set aside.;
        ...
        \App\Recipe::create(array('id' => '19', 'name' => 'Chops With Minted Peas and Wedges',
             ...
             'method' => 'Preheat oven to 180C. Meanwhile prick potatoes all over with a fork and place in microwave on high for 4-5 minutes or until they are soft on the outside but firm in the middle. When cool enough to handle, cut into wedges.;
            Place the wedges on a baking tray, drizzle with half the oil and season with salt and pepper. Toss to coat evenly and bake for 15-20 minutes or until crispy.;
            While the potatoes are cooking, bring a saucepan of salted water to boil. Next strip the mint leaves from the stalks and roughly chop, grate or crush the garlic, finely grate lemon zest and juice the flesh.;
            Place a frypan on medium heat with a drizzle of oil. Add the lamb and cook for 2-3 minutes each side, or until browned and cooked to your liking.;
        ...
        \App\Recipe::create(array('id' => '20', 'name' => 'Pork and Mushroom Alfredo',
             ...
             'method' => 'Three quarter fill a saucepan with water and bring to a boil on high heat. Add fettuccine and a pinch of salt and cook for 10 minutes or until al dente.;
            Meanwhile, thinly slice the onion, slice the mushrooms and finely grate the garlic.;
            Place a large frypan on high heat. Add oil and pork and cook for 2 minutes or until golden brown. Transfer pork to a plate.;
            Return frypan to heat and add onion, mushroom and garlic and cook for 2 minutes.;
            Add milk, parmesan and pork back to the frypan. Reduce to low heat and simmer for 2 minutes to melt the cheese. Meanwhile, drain fettuccine in a colander.;
        ...
        \App\Recipe::create(array('id' => '22', 'name' => 'Montreal Steak with Walnut & Cranberry Couscous',
             ...
             'method' => 'COmbine couscous, cranberries, and a pinch of salt in a heatproof bowl and then cover with boiling water to approximately a centimetre above the level of the couscous. Cover with a plate and set aside.;
            Meanwhile, halve the tomatoes, chop the walnuts and parsley, shred the mint, finely grate the lemon zest and juice the lemon.;
            Combine pepper, salt, mustard, dill, coriander, garlic powder and chilli flakes to form the Montreal spice mix. Season the steaks with approximately 3 teaspoons of spice mix or to taste, coat all sides.;
            Place a large frypan on medium-high heat. Add the steaks to the pan and cook 2-3 minutes on each side or until cooked to your liking. Transfer steaks on a plate covered in foil to rest.;
            Fluff the couscous with a fork and add tomatoes, walnuts, parsley, mint and lemon zest and season with salt, pepper and lemon juice to taste.;
        ...
        \App\Recipe::create(array('id' => '23', 'name' => 'Salmon and Mozzarella Taco',
            ...
            Thinly slice onion, cabbage, radish, spring onion and chilli, halve the tomatoes, finely chop the coriander, grate the lemon zest and juice the lemon.;
            Place a large frypan on medium heat and add some oil, Add onion to pan and cook for 2 minutes or until softened. Add chilli and diced salmon and cook for 2 minutes, turning to sear all sides. Stir in tomatoes, oregano, and paprika. Season well with salt and pepper, then transfer to a plate.;
            Lay tortillas flat on a baking tray and sprinkle with cheese. Bake in the oven for 4 minutes or until cheese is melted. Divide salmon mixture between tortillas, fold in half and return to the oven for a further 2 minutes.;
            While the tortillas bake combine cabbage, radish, spring onion, coriander, lemon zest, lemon juice and remaining oil in a mixing bowl, toss then season with salt and pepper.;
