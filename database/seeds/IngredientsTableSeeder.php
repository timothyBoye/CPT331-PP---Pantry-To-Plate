...
class IngredientsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $ingredients = array(
            ...
            array('name' => 'dried apricot',    'plural' => 'dried apricots', 'ingredient_category_id' => Config::get($fruit), 'ingredient_image_url' => 'Ingredients-DicedApricots_20422-2-x200.jpg'),
            ...
            array('name' => 'green beans',      'plural' => '', 'ingredient_category_id'=> Config::get($veg), 'ingredient_image_url' => 'mange-tout-2-x200.jpg'),

            //veg
            array('name' => 'celeriac',         'plural' => 'celeriacs', 'ingredient_category_id'=> Config::get($veg), 'ingredient_image_url' => 'celeriac.jpeg'),
            array('name' => 'pumpkin',          'plural' => 'pumpkins', 'ingredient_category_id'=> Config::get($veg), 'ingredient_image_url' => 'pumpkin.jpeg'),
            array('name' => 'mangetout',        'plural' => 'mangetouts', 'ingredient_category_id'=> Config::get($veg), 'ingredient_image_url' => 'mangetout.jpg'),
            array('name' => 'cabbage',          'plural' => 'cabbages', 'ingredient_category_id'=> Config::get($veg), 'ingredient_image_url' => 'cabbage.jpeg'),
            ...
            array('name' => 'green chili',      'plural' => 'green chilies', 'ingredient_category_id'=> Config::get($veg), 'ingredient_image_url' => 'green_chili.jpeg'),
            ...
            array('name' => 'dill seeds',        'plural' => '', 'ingredient_category_id'=> Config::get($spice), 'ingredient_image_url' => 'chia-seeds.jpg'),
